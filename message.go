...
// MirrorErrorMessage is emitted by the SDK when a SessionStore.append call fails.
// Non-fatal — the session continues; only the mirrored copy is missing the failed batch.
